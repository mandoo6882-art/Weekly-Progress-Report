...
function parse_SerAr(blob, biff/*:number*/) {
	...
	switch(val[0]) {
		...
		default: val[1] = null; blob.l += 8; break; /* Unknown/corrupt SerAr type: skip gracefully instead of throwing (avoids slow exception handling in some browsers) */
	}
	return val;
}
...
function parse_BrtName(data, length, opts) {
	...
	var formula; try { formula = parse_XLSBNameParsedFormula(data, 0, opts); } catch(e) { formula = [[], '']; }
