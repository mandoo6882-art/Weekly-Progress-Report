...
export async function parseTabFile(tabId, arrayBuffer, filename) {
  ...
  if (tabId === 'procurement') {
    ...
    // 행51(첫 헤더 행)은 큰 병합(Discipline/WF%/This Week Increment/This Week Cumulative),
    // 행52(둘째 헤더 행)은 작은 병합(각 %지표 2열씩).
    const dashTitle = findFirstValueInRow(wsDash, 50, 'X', 'AO');
    const dashMerges = [
      'X51:AA51', 'AB51:AC51', 'AD51:AI51', 'AJ51:AO51',
      'X52:AA52', 'AB52:AC52', 'AD52:AE52', 'AF52:AG52', 'AH52:AI52', 'AJ52:AK52', 'AL52:AM52', 'AN52:AO52',
    ].map((a1) => XLSX.utils.decode_range(a1));
    const dashGrid = extractRangeWithMerges(wsDash, 'X51:AO62', dashMerges);
    ...
    // WV 열(5번째, 0-based)만 백분율로 표시
    const delayRows = formatNumericGrid(rows, [5]);
    result.blocks.push({
      type: 'table',
  ...
  if (tabId === 'construction') {
    ...
    const progMerges = [
      'X30:AA30', 'AB30:AC30', 'AD30:AI30', 'AJ30:AO30',
      'X31:AA31', 'AB31:AC31', 'AD31:AE31', 'AF31:AG31', 'AH31:AI31', 'AJ31:AK31', 'AL31:AM31', 'AN31:AO31',
    ].map((a1) => XLSX.utils.decode_range(a1));
    const progGrid = extractRangeWithMerges(wsDash, 'X30:AO43', progMerges);
    ...
    const qtyMerges = [
      'H48:I48', 'J48:K48', 'M48:N48', 'O48:T48', 'U48:Z48', 'AA48:AB48', 'AC48:AD48',
      'H49:I49', 'J49:K49', 'M49:N49', 'O49:P49', 'Q49:R49', 'S49:T49', 'U49:V49', 'W49:X49', 'Y49:Z49', 'AA49:AB49', 'AC49:AD49',
    ].map((a1) => XLSX.utils.decode_range(a1));
    // AC열(0-based idx21, Completion Date)만 날짜 변환. 나머지는 수량(예: M3 ~29365)이 날짜로 오인식되지 않도록 보호.
    let qtyGrid = extractRangeWithMerges(wsDash, 'H48:AD71', qtyMerges, [21]);
