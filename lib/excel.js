...
export async function parseTabFile(tabId, arrayBuffer, filename) {
  ...
  if (tabId === 'schedule-cooling-tower') {
    ...
    const columns = [
      ...
      { label: 'Duration', width: 56 },
      { label: 'Plan Start', width: 74 },
      { label: 'Plan Finish', width: 74 },
      { label: 'Actual Start', width: 74 },
      { label: 'Actual Finish', width: 74 },
      { label: 'Remark', width: 220 },
    ];
  ...
  if (tabId === 'schedule-ts003') {
    ...
    const columns = [
      ...
      { label: 'Plan Start', width: 70 },
      { label: 'Plan Finish', width: 70 },
      { label: 'Forecast Start', width: 70 },
      { label: 'Forecast Finish', width: 70 },
      { label: 'Actual Start', width: 70 },
      { label: 'Actual Finish', width: 70 },
